...
namespace GovUK.Dfe.FlexForms.Api.Client
{
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <exception cref="ExternalApplicationsException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ApplicationDto> UnDeleteApplicationAsync(System.Guid applicationId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (applicationId == null)
                throw new System.ArgumentNullException("applicationId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v1/Applications/{applicationId}/un-delete"
                    urlBuilder_.Append("v1/Applications/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(applicationId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/un-delete");
                    ...
                    try
                    {
                        ...
                        if (status_ == 403)
                        {
                            ...
                            throw new ExternalApplicationsException<ExceptionResponse>("User does not have permission to un-delete this application", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 404)
                        {
