...
/// <summary>
/// A message type discovered from CoreLibs Messaging.Contracts along with its resolved topic.
/// </summary>
public sealed record DiscoveredMessagingEvent(Type ClrType, string EventTypeName, string? TopicName);
