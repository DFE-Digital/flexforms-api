...
/// Header names match <c>TenantAwareEventPublisher</c> so generic event publishing is unchanged.
/// </summary>
public static class ScanEventRouting
{
    ...
    public static string? ResolveTenantId(Headers headers, ScanResultEvent? scanResult) =>
        ResolveTenantId(headers, scanResult?.Metadata);
